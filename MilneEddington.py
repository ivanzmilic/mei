    ...
    def _initLine(self, label, anomalous, dw, precision):
        ...
        if(precision == 'float64'):
            if(label == 6301):
                ...
                return pyMilne.pyLines(j1 = 0.0, j2 = 1.0, g1 = 0.0, g2 = 3.00, cw = 5250.2089 , gf = 10.**-4.938, anomalous = anomalous, dw = dw)
            elif(label == 5172):
                return pyMilne.pyLines(j1 = 1.0, j2 = 1.0, g1 = 1.50, g2 = 2.02, cw = 5172.6844 , gf = 10.**-0.393, anomalous = anomalous, dw = dw)
            elif(label == 5892): # left line, Fe
                return pyMilne.pyLines(j1 = 3.0, j2 = 3.0, g1 = 1.667, g2 = 2.00, cw = 5892.699 , gf = 10.**-3.10, anomalous = anomalous, dw = dw)
            elif(label == 5893): # right line, Nickel
                return pyMilne.pyLines(j1 = 0.0, j2 = 1.0, g1 = 0.0, g2 = 1.0, cw = 5892.881 , gf = 10.**-2.34, anomalous = anomalous, dw = dw)
